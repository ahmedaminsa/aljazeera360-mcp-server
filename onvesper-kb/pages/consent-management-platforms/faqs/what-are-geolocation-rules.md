> For the complete documentation index, see [llms.txt](https://docs.onvesper.com/platform-knowledge-base/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.onvesper.com/platform-knowledge-base/consent-management-platforms/faqs/what-are-geolocation-rules.md).
...
```
GET https://docs.onvesper.com/platform-knowledge-base/consent-management-platforms/faqs/what-are-geolocation-rules.md?ask=<question>&goal=<endgoal>
```
